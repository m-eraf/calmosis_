...
const itemss = [
  {
    ...
    answer:
      "Cannabis extract exhibits calming effects that can contribute to natural stress and anxiety relief.",
  },
  {
        ...
        <div className="content">
            ...
            {isAboveShopVisible && (
              ...
              >
                <div className="labell">
                  <div className="text-wrapperr ">Peace mantra</div>
                </div>
                <div className="box">
          ...
          >
            <div className=" left">
              ...
              >
                <img src="./peace_inner_shop.png" alt="" />
              </motion.div>
              <div>
                {" "}
                <p>
                  Introducing "Peace Mantra," our remarkable product that
                  reflects our unwavering dedication to holistic well-being. But
                  that's not all. "Peace Mantra" is a versatile elixir renowned
                  for improving sleep quality enhancing cognitive function,and
                  promoting sexual wellness, amongst other health benefits.
                  <br /> <a href="#desc-peace">Know More</a>
                </p>
              </div>
              <div className="price">
                ₹4500 
          ...
          <div className="about">
            <div className="desc" id="desc-peace">
              <h1>Description</h1>

              <p>
                <span>
                  Introducing "Peace Mantra," our remarkable product that
                  reflects our unwavering dedication to holistic well-being. Our
                  meticulous formulation harmonizes with the body's
                  Endocannabinoid System (ECS) to offer unparalleled relief for
                  stress, anxiety, period discomfort, and gentle pain. But
                  that's not all. "Peace Mantra" is a versatile elixir renowned
                  for improving sleep quality, enhancing cognitive function, and
                  promoting sexual wellness, amongst other health benefits.
                </span>
                ...
                <span>
                  It's time to embark on your holistic journey towards a more
                  balanced, tranquil, and vibrant life. Don't settle for
                  mediocre solutions. Choose "Peace Mantra" - the ultimate THC
                  and CBD enriched tranquility elixir. Our unique blend is
                  expertly crafted to help you unwind and relax, providing a
                  powerful and rejuvenating experience that will leave you
                  feeling revitalized. Order now and discover the natural power
                  of relaxation.
                </span>
              </p>
            </div>
            <div className="howw">
              <div className="benefits">
                <div className="inner">
                  ...
                  <div className="right">
                    <img src="./peace_shop_item.png" alt="" />
                  </div>
                </div>
